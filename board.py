...
# Valid move, CONVERT hex NUMBER TO char value [A, 9] , [A, 8]
...
def validMove(move):
    ...
    s = 1
    d = []
#[23, 35, 36, 48, 49, 61, 62, 74, 75, 87, 88]
#[0, 12, 13, 25, 26, 38, 39, 51, 52, 64, 65]
...
def getRowCol(pos):
    ...
    try:
        row = [n * 11 - 5 for n in xrange(1,12)].index(pos) + 1
        col = 'F' #70
        return [row, col]
    except ValueError:
        pass
